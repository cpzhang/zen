...
const Class_ID RocketExporter::tCID(tMaxExporterCID);
const int RocketExporter::tVersion(30);
const std::string RocketExporter::tName("Rocket Exporter");
const std::string RocketExporter::tLongDesc("Rocket 3D Max Exporter");
