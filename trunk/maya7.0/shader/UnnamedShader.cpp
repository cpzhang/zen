...
MStatus UnnamedShader::initialize()
{
	...
	eAttr.addField("Blend Alpha",2);
	eAttr.addField("Additive Old",3);
	eAttr.addField("Additive Alpha",4);
	eAttr.addField("Modulate Old",5);
	eAttr.addField("Modulate 2X Color",6);
	eAttr.addField("Modulate Color",7);
	eAttr.addField("Modulate Alpha",8);
	eAttr.addField("Modulate 2X Alpha",9);
	eAttr.addField("Additive 1/2X Color",10);
	eAttr.addField("Additive Color",11);
	eAttr.addField("Exclusion 1/2X Alpha",12);
	eAttr.addField("Exclusion Alpha",13);
	eAttr.addField("Exclusion 1/2X Color",14);
	eAttr.addField("Exclusion Color",15);
